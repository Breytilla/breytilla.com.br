...
export const metadata: Metadata = {
  ...
  description:
    "Como os dados enviados pelos formulários de contato e newsletter da Breytilla são utilizados e protegidos.",
  alternates: {
  ...
  return (
    <main className="privacy-page">
      ...
      <article className="container privacy-content">
        ...
        <p className="privacy-version">Versão de 20 de agosto de 2026.</p>
        <p className="privacy-lead">
          Este aviso explica, de forma objetiva, como os dados enviados pelos
          formulários deste site são utilizados. Os formulários não são um
          canal de atendimento clínico e não solicitam relatos sobre saúde ou
          sobre o motivo da busca por psicoterapia.
        </p>
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            Chaves de acesso permanecem no servidor, e o sistema não registra o
            conteúdo dos e-mails nem endereços em logs de aplicação.
          </p>
        </section>
